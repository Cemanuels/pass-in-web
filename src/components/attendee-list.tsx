          ...
          <tbody className="border-b border-white/10">
            {Array.from({length: 8}).map((_v, i) => {
              ...
              <tr key={i} className="hover:bg-white/5">
                <td className="w-[48px] py-3 px-4 text-sm text-zinc-300">
                  <input className="size-4 bg-black/20 rounded border-white/10" type="checkbox" />
                </td>
                <td className="py-3 px-4 text-sm text-zinc-300">12832</td>
                <td className="py-3 px-4 text-sm text-zinc-300">
                  <div className="flex flex-col gap-1">
                    <span className="font-semibold text-white">Caio Emanuel</span>
                    <span>c.emanuels@icloud.com</span>
                  </div>
                </td>
